...
Mapping Potentiometer sensor analog signal(0 to 1023)to the loudness of Buzzer(0 to 255).
...
Adjust the potentiometer to adjust the volume of the buzzer beeps.
